...
// NOTE: SplitText is a premium GSAP plugin. If you do not have a Club GSAP license,
// this import will fail. For this demo, we will try to safe-guard or you might need
// to swap to a standard text animation or install the trial package.
// import { SplitText } from 'gsap/SplitText'; 

// fallback mock if module missing (logic to be handled if build fails, keeping import for now as requested)
// We will comment it out and use a fallback for now to ensure it works for the user immediately without $$$
// import { SplitText } from 'gsap/SplitText';
...
export default function Hero({
    ...
    useGSAP(
        () => {
            ...
            // Note: Replaced SplitText with simple fade/stagger for standard GSAP compatibility
            ...
            // Adjusted animation for non-split text
